...
//                     }`}
//                     className="outline-none w-full bg-white rounded-md responsive-input"
//                     ref={text}
//                   />
//                 </div>
//                 <div className="mx-4">
...
//             className="bg-red-700 py-1 rounded-md"
//           ></span>
...
//             </div>
//           ) : (
//             <div className="responsive-posts">
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-col py-4 w-full bg-white rounded-3xl shadow-lg">
          <div className="flex items-center border-b-2 border-gray-300 pb-4 pl-4 w-full">
            ...
            />
            <form className="w-full" onSubmit={handleSubmitPost}>
              <div className="flex justify-between items-center flex-col md:flex-row md:flex-wrap md:items-start">
                <div className="w-full ml-4 md:w-4/5 md:ml-0">
                  <input
                    type="text"
                    name="text"
                    placeholder={`Whats on your mind ${
                ...
                <div className="mx-4 mt-4 md:m-0">
                  {image && (
                    <img
                      className="h-24 rounded-xl"
                      src={image}
                ...
                <div className="mr-4 mt-4 md:m-0">
                  <Button variant="text" type="submit">
                    Share
                  </Button>
                </div>
